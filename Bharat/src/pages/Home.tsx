...
import { MobileCarousel } from "../components/MobileCarousel"; // Import MobileCarousel
        ...
        <>
            ...
            >
                <div className="max-w-[1200px] mx-auto">
                    ...
                    <MobileCarousel
                        items={[
                            { image: imgImage35, caption: "Versatility and presence from subtle to striking — roles across film, series, ads, and music videos.", className: "h-[310px]", imageClassName: "object-[50%_25%]", onClick: () => navigate('/performance') },
                            { image: imgImage25, caption: "Performance is instinct — shaped by character and camera.", className: "h-[310px]", onClick: () => navigate('/performance') },
                            { image: imgImage22, caption: "A screen presence shaped by stillness, expression, and narrative flow.", className: "h-[310px]", onClick: () => navigate('/performance') }
                        ]}
                    />
